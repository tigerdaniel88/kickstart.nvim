...
-- 4 space indent and tab
vim.o.tabstop = 4 -- A TAB character looks like 4 spaces
vim.o.expandtab = true -- Pressing the TAB key will insert spaces
vim.softtabstop = 4 -- Number of spaces inserted instead of a TAB
...
-- prevent cursor to jump when searching.
vim.keymap.set('n', '*', '*``', { desc='prevent cursor from jumping when searching.'})
